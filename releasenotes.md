...
- **RELATED**: a TypeScript-specific API reference for the latest version and the LTS versions of both OpenUI5 and SAPUI5 has been published at [https://ui5.github.io/typescript/api](https://ui5.github.io/typescript/api). In contrast to the regular API reference in the UI5 demokit, this one also contains types which are only available in the TypeScript API, like the event-specific event parameter types, e.g. [`DatePicker$ChangeEventParameters`](https://ui5.github.io/typescript/api/openui5/1.136/sap.m/sap/m/DatePicker/interfaces/DatePicker$ChangeEventParameters.html)
