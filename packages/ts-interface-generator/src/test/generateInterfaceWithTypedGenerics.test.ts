...
declare module "./SampleGenericManagedObject" {
    ...
    export default interface SampleGenericManagedObject<TOptions extends $UIComponentSettings, TOptions2 extends $RenamedComponentSettings, TOptions3 extends Component, TOptions4 extends {} = any> {
