...
declare module "./SampleWebComponent" {
  ...
  export default interface SampleWebComponent {
     ...
     */
    attachDoublePress(
      fn: (event: SampleWebComponent$DoublePressEvent) => void,
      listener?: object
    ): this;
    ...
    attachDoublePress<CustomDataType extends object>(
      data: CustomDataType,
      fn: (
        event: SampleWebComponent$DoublePressEvent,
        data: CustomDataType
      ) => void,
      listener?: object
    ): this;
     ...
     */
    fireDoublePress(
      parameters?: SampleWebComponent$DoublePressEventParameters
    ): boolean;
  }
   ...
   * Fired when double-clicked.
   */
  export type SampleWebComponent$DoublePressEvent =
    Event<SampleWebComponent$DoublePressEventParameters>;
}
